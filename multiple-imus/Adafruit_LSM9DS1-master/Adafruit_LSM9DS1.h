...
class Adafruit_LSM9DS1
{
  public:
    ...
    Adafruit_LSM9DS1 ( int8_t xgcs, int32_t sensorID = 0 );
    Adafruit_LSM9DS1 ( int8_t clk, int8_t miso, int8_t mosi, int8_t xgcs, int32_t sensorID = 0 );
