...
#define LSM9DS1_SCK 8
#define LSM9DS1_MISO 9
#define LSM9DS1_MOSI 10

#define LSM9DS1_XGCS1 2 // CHIP SELECT IMU 1
#define LSM9DS1_XGCS2 3 // CHIP SELECT IMU 2
#define LSM9DS1_XGCS3 13 // CHIP SELECT IMU 3
